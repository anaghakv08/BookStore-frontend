...
import { addBookAPI, deleteAUserAddedBookAPI, getPurchasedBookAPI, getUserBooksAPI } from '../../Services/allAPI'
...
function Profile() {
  ...
  const handleAddBook = async () => {
    ...
    if (!title || !author || !noofPages || !imageUrl || !price || !dprice || !abstract || !publisher || !language || !isbn || !category || uploadImages.length == 0) {
      ...
      // reqbody- form data() //append-reqbody.append(key,value)//reqbody.append("title",title)
  ...
  const handleDeleteBoook = async (id) => {
    try {
  ...
  const allPurchasedBooks = async () => {
    ...
    try {
      const result = await getPurchasedBookAPI(reqHeader)
  ...
  return (
    <>
      ...
      <div className='bg-white p-3' style={{ width: "230px", height: "230px", borderRadius: "50%", marginLeft: "70px", marginTop: "-130px" }}>
        <img src={userProfile =="" ? "https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_640.png" : userProfile.startsWith("https")? userProfile : `${SERVERURL}/imguploads/${userProfile}`} alt="" style={{ width: "200px", height: "200px", borderRadius: "50%" }} />
      </div>
      ...
      <div className='flex justify-center items-center my-8 font-medium text-lg'>
        ...
        <p onClick={() => { setSellbooks(false), setBookStatus(false), setPurchaseHistory(true), allPurchasedBooks() }} className={purchaseHistory ? 'text-blue-500 p-4 border-gray-200 border-t border-l border-r rounded cursor-pointer' : 'p-4 border-b border-gray-200 cursor-pointer'}>Purchase History</p>
      </div>
            ...
            <form className='md:grid grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <div className="flex flex-col items-center justify-center text-center mt-10">
                  ...
                  {preview &&
                    <div className='mt-10 flex flex items-center gap-5'>
                      ...
                      {allUploadImages.length < 3 &&
                        <label htmlFor="uploadfile" className='mt-5'>
                          <input onChange={(e) => handleFile(e)} type="file" name="" id="uploadfile" style={{ display: "none" }} />
            ...
            userAddedBooks?.map((book) => (
              ...
              <div className='bg-gray-200 p-5 rounded mt-4'>
                <div className='md:grid grid-cols-[3fr_1fr]'>
                  ...
                  <div className='px-4 mt-4 md:mt-4 flex justify-center items-center flex-col mt-10'>
                    <img src={book?.imageUrl} alt="" className='w-52 h-76 object-cover rounded' />
                    <div className='flex justify-end mt-4'>
                      <button onClick={() => handleDeleteBoook(book?._id)} type='button' className='p-2  rounded bg-red-600 text-white hover:bg-gray-200 hover:text-red-600 hover:border hover:border-red-600'>Delete</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {purchaseHistory &&
        ...
        (
          ...
          <div className='p-10 my-20 shadow rounded'>
            ...
            <h2 className='text-xl font-bold mb-5'>Your Purchase History</h2>
