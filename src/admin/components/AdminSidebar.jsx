    ...
    <>
      <div className='bg-gray-200 w-full md:min-h-screen flex items-center flex-col'>
        ...
        <div className='mb-10'>
          ...
          <div className='mb-4 flex'>
            <input type="radio" name="" id="book" readOnly />
            <Link to={"/admin-books"}>
              <label htmlFor="book" className='flex ms-3'><PiBooks className='mt-1 me-1' />Books</label>

            </Link>
          </div>
          <div className='mb-4 flex'>
            <input type="radio" name="" id="carrer" readOnly />
            <Link to={"/admin-careers"}>
              <label htmlFor="carrer" className='flex ms-3'><FaGraduationCap className='mt-1 me-1' />Careers</label>
