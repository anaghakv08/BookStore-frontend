              ...
              <table className='w-full my-3 shadow'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-500 p-3 text-center'>Josheph</td>
                    <td className='border border-gray-500 p-3 text-center'>B tech</td>
                    <td className='border border-gray-500 p-3 text-center'>joseph@gmail.com</td>
                    <td className='border border-gray-500 p-3 text-center'>7896541230</td>
                    <td className='border border-gray-500 p-3 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate totam similique quia in, ullam sint molestiae nihil debitis? Veniam deleniti omnis quasi ab eius iusto consectetur repellat molestias quo cum?</td>
